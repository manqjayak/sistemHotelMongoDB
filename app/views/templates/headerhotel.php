...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL ?>public/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= BASEURL ?>public/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?= BASEURL ?>public/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= BASEURL ?>public/plugins/summernote/summernote-bs4.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?= BASEURL ?>" class="brand-link mr-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?= BASEURL ?>kamar" class="nav-link">
