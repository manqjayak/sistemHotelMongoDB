...
<!-- ChartJS -->
<script src="<?= BASEURL ?>public/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="<?= BASEURL ?>public/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="<?= BASEURL ?>public/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="<?= BASEURL ?>public/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?= BASEURL ?>public/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?= BASEURL ?>public/plugins/moment/moment.min.js"></script>
<script src="<?= BASEURL ?>public/plugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="<?= BASEURL ?>public/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="<?= BASEURL ?>public/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
...
<script src="<?= BASEURL ?>public/dist/js/pages/dashboard.js"></script>
